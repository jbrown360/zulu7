...
class SpeedtestManager {
  ...
  async runTest() {
    ...
    this.isTesting = true;
    console.log("[Vite Speedtest] Running scheduled measurement...");
    ...
    try {
      ...
      console.log(`[Vite Speedtest] Success: Dn=${download}Mbps, Up=${upload}Mbps, Ping=${ping}ms`);
    } catch (err) {
      console.error("[Vite Speedtest] Measurement failed:", err);
    } finally {
      this.isTesting = false;
    }
  }
