                    ...
                    {wsData.widgets.map(widget => (
                        ...
                        >
                            ...
                            >
                                ...
                                {!isLocked && !isPreload && (
                                    <div className={`zulu-drag-handle absolute top-0 left-0 w-full h-10 px-3 z-40 cursor-grab active:cursor-grabbing flex items-center justify-start bg-[#0a0f18]/95 text-white/50 hover:text-zulu-orange border-b border-white/5 transition-colors ${isDragging ? 'pointer-events-auto' : ''}`}>
                                        {widget.type === 'iframe' ? (() => {
                            ...
                            {!isLocked && !isPreload && (
                                <div
                                    className="absolute top-1 right-1 flex items-center bg-[#0a0f18]/95 rounded-none border border-white/20 z-[200] no-drag overflow-hidden pointer-events-auto shadow-2xl"
