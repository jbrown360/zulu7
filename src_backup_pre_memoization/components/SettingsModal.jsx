...
const SettingsModal = ({ isOpen, onClose, onSave, initialSettings, activeTab, setActiveTab, activeWorkspace }) => {
    ...
    useEffect(() => {
        ...
        fetchHistory();
        const interval = setInterval(fetchHistory, 10000); // 10s
        return () => clearInterval(interval);
    }, [showLoadGraph, isLocal]);
    ...
    return (
        ...
        >
                    ...
                    {activeTab === 'general' && (
                        <div className="space-y-6">
                            ...
                            <div className="space-y-4 p-4 bg-blue-500/10 border border-blue-500/20 rounded-none">
                                <div className="space-y-1">
                                    <h3 className="text-[10px] uppercase font-bold tracking-widest text-blue-100 flex items-center">
                                        <Monitor size={14} className="mr-2 text-blue-400" />
                                        Zulu7
                                    </h3>
                            ...
                            <div className="space-y-4 p-4 bg-blue-500/10 border border-blue-500/20 rounded-none">
                                <div className="space-y-1">
                                    <h3 className="text-[10px] uppercase font-bold tracking-widest text-blue-100 flex items-center">
                                        <Key size={14} className="mr-2 text-blue-400" />
                                        External API Keys
                                    </h3>
                                    <p className="text-[10px] text-blue-200/50">
                                ...
                                <div className="space-y-1">
                                    <h3 className="text-[10px] uppercase font-bold tracking-widest text-blue-100 flex items-center justify-between">
                                        <div className="flex items-center">
                                            <Layout size={14} className="mr-2 text-blue-400" />
                                            Dashboard Selection
                                        </div>
                            ...
                            <div className="space-y-4 p-4 bg-blue-500/10 border border-blue-500/20 rounded-none">
                                <div className="flex items-center justify-between">
                                    <div className="space-y-1">
                                        <h3 className="text-[10px] uppercase font-bold tracking-widest text-blue-100 flex items-center">
                                            <Image size={14} className="mr-2 text-blue-400" />
                                            Visual System
                                        </h3>
                                        <p className="text-[10px] text-blue-200/50">
                    ...
                    {activeTab === 'streams' && (
                        <div className="space-y-6">
                            ...
                            <div className="space-y-4 p-4 bg-blue-500/10 border border-blue-500/20 rounded-none">
                                <div className="space-y-1">
                                    <h3 className="text-[10px] uppercase font-bold tracking-widest text-blue-100 flex items-center">
                                        <Server size={14} className="mr-2 text-blue-400" />
                                        Streamer Endpoint
                                    </h3>
                                    <p className="text-[10px] text-blue-200/50">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-none space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        >
                                            <FileDown size={20} className="text-blue-400 group-hover:text-blue-300 transition-colors mr-3" />
                                        ...
                                        <label className="flex items-center justify-center p-3 bg-white/5 border border-white/10 rounded-none hover:bg-white/10 transition-all group cursor-pointer" title="Upload JSON Backup">
                                            <FileUp size={20} className="text-blue-400 group-hover:text-blue-300 transition-colors mr-3" />
                ...
                < div className="p-4 border-t border-white/5 bg-white/5 flex items-center justify-between" >
                    <div className="flex items-center space-x-4">
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-xs font-bold text-orange-500 tracking-[0.2em] uppercase hover:text-orange-400 transition-colors"
                        >
                            Zulu7
                        </a>
                        {(!isLocal || !systemLoad) ? (
                            <div className="flex items-center space-x-3 text-xs font-bold text-red-500 tracking-[0.2em] uppercase border-l border-white/10 pl-4">
                                {isLocal ? "System Load Fetch Failed" : "Non-Local Connection Disabled"}
                            </div>
                        ) : (
                            <div 
                                className="flex items-center space-x-3 text-xs font-bold text-white/40 tracking-[0.2em] uppercase border-l border-white/10 pl-4 cursor-pointer bg-white/5 hover:bg-white/10 hover:text-white transition-colors group p-2 rounded border"
                                onClick={() => setShowLoadGraph(true)}
                                title="View Interactive CPU Load Graph"
                            >
                                <Activity size={14} className="mr-1 text-blue-400" />
                                <div className="flex items-center px-2 py-1">
                                    <span title="1-Minute Load Average" className="group-hover:text-emerald-500 transition-colors">{systemLoad.load1}</span>
                                    <span className="mx-1 text-white/10">,</span>
                                    <span title="5-Minute Load Average" className="group-hover:text-blue-500 transition-colors">{systemLoad.load5}</span>
                                    <span className="mx-1 text-white/10">,</span>
                                    <span title="15-Minute Load Average" className="group-hover:text-amber-500 transition-colors">{systemLoad.load15}</span>
                                    <span className="text-white/10 mx-2">|</span>
                                    <span title="CPU Core Count" className="text-orange-500">{systemLoad.cores}</span>
                                </div>
                            </div>
                        )}
                    </div>
            ...
            {/* Fullscreen Load Graph Modal Overlay */}
            {showLoadGraph && (
                <div className="fixed inset-0 z-[100] bg-[#0a0f18]/95 backdrop-blur-md flex flex-col" onClick={() => setShowLoadGraph(false)}>
                    <div className="flex flex-none items-center justify-between p-6 border-b border-white/5 bg-black/20" onClick={e => e.stopPropagation()}>
                        <h2 className="text-xl font-bold text-white tracking-widest uppercase flex items-center">
                            <Activity size={24} className="mr-3 text-blue-400" />
                            Host Load
                            {systemLoad && typeof systemLoad.load1 !== 'undefined' && (
                                <div className="ml-6 flex items-center text-sm font-mono tracking-wider space-x-3 bg-white/5 px-4 py-1 rounded border border-white/10">
                                    <span title="1-Minute Load Average" className="text-emerald-500">{systemLoad.load1}</span>
                                    <span className="text-white/20">|</span>
                                    <span title="5-Minute Load Average" className="text-blue-500">{systemLoad.load5}</span>
                                    <span className="text-white/20">|</span>
                                    <span title="15-Minute Load Average" className="text-amber-500">{systemLoad.load15}</span>
                                </div>
                            )}
                        </h2>
                        <button onClick={() => setShowLoadGraph(false)} className="text-white/40 hover:text-white p-2 rounded transition-colors cursor-pointer bg-white/5 hover:bg-red-500/20 hover:text-red-400">
                            <X size={24} />
                        </button>
                    </div>
                    <div className="flex-1 flex flex-col min-h-0 relative p-4 lg:p-8" onClick={e => e.stopPropagation()}>
                        {loadHistory.length === 0 ? (
                            <div className="flex-1 flex items-center justify-center flex-col space-y-4">
                                <Loader2 className="animate-spin text-blue-500" size={48} />
                                <div className="text-lg text-white/40 uppercase tracking-widest font-bold">Aggregating Metric History...</div>
                            </div>
                        ) : (
                            <div className="relative flex-1 w-full h-full flex flex-col">
                                {/* SVG Graph Container */}
                                <div className="relative w-full flex-1 border-l border-b border-white/20">
                                    {/* Horizontal Guidelines */}
                                    {[0, 0.25, 0.5, 0.75, 1].map(ratio => (
                                        <div key={ratio} className="absolute w-full border-t border-white/5 border-dashed" style={{ bottom: `${ratio * 100}%` }}>
                                            <span className="absolute -left-10 -translate-y-1/2 text-[10px] text-white/30 font-mono tracking-widest">
                                                {((Math.max(...loadHistory.map(p => Math.max(p.load1, p.load5, p.load15, systemLoad?.cores || 4)))) * ratio).toFixed(1)}
                                            </span>
                                        </div>
                                    ))}
                                    ...
                                    <svg className="absolute inset-0 w-full h-full overflow-visible pointer-events-none" preserveAspectRatio="none">
                                        ...
                                        {(() => {
                                            const maxPeak = Math.max(...loadHistory.map(p => Math.max(p.load1, p.load5, p.load15, systemLoad?.cores || 4))) * 1.1; // 10% headroom
                                            const pointsCount = loadHistory.length;
                                            
                                            // Map abstract history points to internal 0-100% SVG coordinate system
                                            // For path strings, we will just map them internally 0->1000 width, 0->1000 height and let SVG scale it.
                                            const getPath = (key) => {
                                                if (pointsCount === 1) return `M 0,${1000 - (loadHistory[0][key]/maxPeak*1000)} L 1000,${1000 - (loadHistory[0][key]/maxPeak*1000)}`;
                                                return loadHistory.map((point, i) => {
                                                    const x = (i / (pointsCount - 1)) * 1000;
                                                    const y = 1000 - ((point[key] / maxPeak) * 1000);
                                                    return `${i === 0 ? 'M' : 'L'} ${x},${y}`;
                                                }).join(' ');
                                            };
                                            ...
                                            const getAreaPath = (key) => {
                                                ...
                                                return `${path} L 1000,1000 L 0,1000 Z`;
                                            };
                                            ...
                                            return (
                                                <svg viewBox="0 0 1000 1000" className="w-full h-full" preserveAspectRatio="none">
                                                    ...
                                                    {/* Fill Gradients */}
                                                    <defs>
                                                        <linearGradient id="grad15m" x1="0" x2="0" y1="0" y2="1">
                                                            <stop offset="0%" stopColor="#f59e0b" stopOpacity="0.05"/>
                                                            <stop offset="100%" stopColor="#f59e0b" stopOpacity="0"/>
                                                        </linearGradient>
                                                        <linearGradient id="grad5m" x1="0" x2="0" y1="0" y2="1">
                                                    ...
                                                    {/* 15 Minute Average Area + Line */}
                                                    <path d={getAreaPath('load15')} fill="url(#grad15m)" />
                                                    <path d={getPath('load15')} fill="none" stroke="#f59e0b" strokeOpacity="0.6" strokeWidth="1.5" strokeLinejoin="round" vectorEffect="non-scaling-stroke" />

                                                    {/* 5 Minute Average Area + Line */}
                                                    <path d={getAreaPath('load5')} fill="url(#grad5m)" />
                                                    <path d={getPath('load5')} fill="none" stroke="#3b82f6" strokeOpacity="0.6" strokeWidth="1.5" strokeLinejoin="round" vectorEffect="non-scaling-stroke" />

                                                    {/* 1 Minute Average Area + Line */}
                                                    <path d={getAreaPath('load1')} fill="url(#grad1m)" />
                                                    <path d={getPath('load1')} fill="none" stroke="#10b981" strokeOpacity="0.6" strokeWidth="1.5" strokeLinejoin="round" vectorEffect="non-scaling-stroke" />
                                                </svg>
                                            );
                                        })()}
                                    </svg>

                                    {/* Hover interaction layer mapped transparently over the entire graph box */}
                                    <div className="absolute inset-0 w-full h-full flex justify-between">
                                        {loadHistory.map((point, i) => (
                                            <div key={i} className="flex-1 h-full group relative cursor-crosshair">
                                                {/* Vertical Highlight Bar */}
                                                <div className="absolute inset-y-0 left-1/2 -translate-x-1/2 w-[1px] bg-white/0 group-hover:bg-white/30 transition-colors pointer-events-none" />
                                                
                                                {/* Tooltip Overlay */}
                                                <div className="absolute top-[10%] left-1/2 -translate-x-1/2 hidden group-hover:flex flex-col bg-slate-900/90 backdrop-blur-xl border border-white/20 text-sm p-4 rounded shadow-2xl whitespace-nowrap z-50 pointer-events-none scale-110">
                                                    <div className="text-white/60 mb-2 font-mono tracking-widest text-center border-b border-white/10 pb-2">{new Date(point.timestamp).toLocaleTimeString()}</div>
                                                    <div className="text-cyan-300 font-bold flex justify-between gap-8 mt-1"><span>1-Minute Line:</span> <span>{point.load1}</span></div>
                                                    <div className="text-blue-400 font-bold flex justify-between gap-8 mt-1"><span>5-Minute Line:</span> <span>{point.load5}</span></div>
                                                    <div className="text-amber-400 font-bold flex justify-between gap-8 mt-1"><span>15-Minute Line:</span> <span>{point.load15}</span></div>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                                ...
                                {/* Graph Legend Key below the graph axis */}
                                <div className="flex-none mt-6 flex items-center justify-center space-x-12 text-sm font-bold tracking-widest uppercase">
                                    <div className="flex items-center text-cyan-300"><div className="w-4 h-4 bg-cyan-300 mr-3 rounded" /> 1-Minute Load Average</div>
                                    <div className="flex items-center text-blue-400"><div className="w-4 h-4 bg-blue-400 mr-3 rounded" /> 5-Minute Load Average</div>
                                    <div className="flex items-center text-amber-400"><div className="w-4 h-4 bg-amber-400 mr-3 rounded" /> 15-Minute Load Average</div>
                                </div>
                            </div>
                        )}
                    </div>
