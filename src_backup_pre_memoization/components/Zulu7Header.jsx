...
import { Plus, SlidersHorizontal, Lock, Unlock, CalendarDays, Play, Pause, Minus, ChevronDown, Square, Share2, X, History, Monitor, Tv, Calendar, DollarSign, Cake, Copy, Check, Pencil, GripVertical, RefreshCw } from 'lucide-react';
                    ...
                    {!isRestricted && (
                        <button
                            ...
                            className={`
                                ...
                                text-orange-500 hover:text-orange-400 hover:scale-150 hover:drop-shadow-[0_0_8px_rgba(249,115,22,0.8)] active:scale-95
                            `}
                ...
                <div ref={rightSideRef} className="flex items-center gap-2">
                            ...
                            <div className="hidden md:flex items-center gap-2 text-white/90 font-mono tracking-wider text-sm">
                                ...
                                <button
                                    onClick={(e) => {
                                        ...
                                        url.searchParams.set('w', activeWorkspace + 1);
                                        window.location.href = url.href;
                                    }}
                                    className="flex items-center justify-center transition-all duration-300 cursor-pointer mr-3 text-orange-500 hover:text-orange-400 hover:scale-150 hover:drop-shadow-[0_0_8px_rgba(249,115,22,0.8)] active:scale-95"
                                    title="Hard Force Reload Dashboard (Clear Cache)"
                                >
                                    <RefreshCw size={18} strokeWidth={3} className={isReloading ? 'animate-spin' : ''} />
                                </button>
                    ...
                    <button
                        ...
                        className={`
                            ...
                            ${disablePersistence ? 'cursor-pointer hover:scale-150 hover:drop-shadow-[0_0_8px_rgba(249,115,22,0.8)] active:scale-95 text-orange-500 hover:text-orange-400' : 'cursor-pointer hover:scale-150 hover:drop-shadow-[0_0_8px_rgba(249,115,22,0.8)] active:scale-95 text-orange-500 hover:text-orange-400'}
                        `}
