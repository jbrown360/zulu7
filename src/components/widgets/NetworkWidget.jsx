            ...
            <div className="mb-3 shrink-0 relative z-10">
                <h3 className="widget-title flex items-center justify-between">
                    <span className={`flex items-center gap-2 ${unknownCount > 0 ? 'text-orange-500' : 'text-orange-500/90'}`}>
                        ...
                        {displayName}
                        {devices.length > 0 && (
                            <span className="text-slate-500 ml-1 font-normal tracking-wide">
                                {devices.length} Active IPs Detected
                            </span>
                        )}
                    </span>
                </h3>
                <div className="flex gap-2 text-sm mt-3 flex-wrap items-center">
                    ...
                    <div className="relative ml-2 flex items-center group">
                        <Search className="absolute left-2 text-slate-500 z-10 pointer-events-none" size={14} />
                        <input 
                            type="text"
                            placeholder="Find by name or IP..."
                            value={searchQuery}
                            onChange={(e) => setSearchQuery(e.target.value)}
                            className="bg-black/30 border border-slate-700/50 rounded pl-7 pr-8 py-1.5 text-xs text-slate-300 placeholder-slate-600 focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 transition-all w-40 focus:w-56 relative z-0"
                        />
                        {searchQuery && (
                            <button 
                                type="button"
                                ...
                                className="absolute right-2 text-slate-500 hover:text-slate-300 transition-colors z-[100] cursor-pointer"
                                title="Clear Search"
                            >
